...
func NewEstimateStrategyFactory(partsSupplyRepo interfaces.IPartsSupplyGateway, billingServiceRepo interfaces.IBillingServiceGateway) *EstimateStrategyFactory {
